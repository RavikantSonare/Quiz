    ...
    public partial class OnlineTestStart : System.Web.UI.Page
    {
        ...
        protected void DataList1_ItemDataBound(object sender, DataListItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item)
            {
                ...
                imgHotSpot.ImageUrl = Common.FullyQualifiedApplicationPath + "/resource/" + _examqueanslist.QuestionList.Where(q => q.QAId.Equals(QuestionID)).FirstOrDefault().Resource;
