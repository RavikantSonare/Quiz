        ...
        private List<BOQAManage> GetQuestionList()
        {
            List<BOQAManage> _qustionlist = (from li in _datatable.AsEnumerable()
                                             select new BOQAManage
                                             {
                                                 ...
                                                 Resource = !string.IsNullOrEmpty(li.Field<string>("Resource")) ? "http://quizmerchant.mobi96.org/resource/" + li.Field<string>("Resource") : "",
                                                 Exhibit = !string.IsNullOrEmpty(li.Field<string>("Exhibit")) ? "http://quizmerchant.mobi96.org/resource/" + li.Field<string>("Exhibit") : "",
                                                 Topology = !string.IsNullOrEmpty(li.Field<string>("Topology")) ? "http://quizmerchant.mobi96.org/resource/" + li.Field<string>("Topology") : "",
                                                 Scenario = !string.IsNullOrEmpty(li.Field<string>("Scenario")) ? "http://quizmerchant.mobi96.org/resource/" + li.Field<string>("Scenario") : "",
