<%@ Page Title="" Language="C#" MasterPageFile="~/Merchant.Master" AutoEventWireup="true" CodeBehind="MerchantDragdrop.aspx.cs" Inherits="WebMerchant.MerchantDragdrop" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function initDragDrop(e) {
            ...
            dragContentDiv.style.left = (e.clientX + Math.max(document.documentElement.scrollLeft, document.body.scrollLeft)) - 300 + 'px';
        ...
        function dragDropMove(e) {
            ...
            dragContentDiv.style.left = (e.clientX + scrollLeft) - 300 + 'px';
    ...
    <div id="dragScriptContainer">
        <div id="questionDiv">
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <div class="dragDropSmallBox" id='<%#Eval("AnswerId")%>'><%#Eval("Answer")%></div>
        ...
        <div id="answerDiv">
            <asp:Repeater ID="Repeater2" runat="server">
                <ItemTemplate>
                    <div class="dragDropSmallBox" id='<%#Eval("AnswerId")%>'><%#Eval("RightAnswer")%></div>
                </ItemTemplate>
            </asp:Repeater>
        </div>
        <%-- <div id="questionDiv">
