...
var summerHtmlImageMapCreator = (function () {
        ...
        return {
            ...
            preview: (function () {
                ...
                return function () {
                    ...
                    domElements.map.innerHTML = app.getHTMLCode()[0];
                    code.print();
                    return this;
                };
            })(),
    ...
    var code = (function () {
        var block = utils.id('code'),
            content = utils.id('ContentPlaceHolder1_code_content'),
            close_button = block.querySelector('.close_button');
        ...
        return {
            print: function () {
                var getarr = app.getHTMLCode(true);
                content.innerHTML = getarr[0];
                $('#ContentPlaceHolder1_txtimage').attr('value', getarr[1]);
                $('#ContentPlaceHolder1_txtmaphtml').attr('value', getarr[2]);
                utils.show(block);
            },
            hide: function () {
                utils.hide(block);
