    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            if (keysQ.Count > 0)
            {
                ...
                {
                    int txtId = Convert.ToInt16(key.Substring(30));
        ...
        private void CreateTextBoxQ(string id, int i)
        {
            ...
            //var data = pnlQuestion;
            ////pnlQuestion.Controls.Add(lt);
            //// Panel pnl = (Panel)Page.LoadControl("pnlQuestion");
            ContentPlaceHolder cph = (ContentPlaceHolder)this.Master.FindControl("ContentPlaceHolder1");
            Panel panel = (Panel)cph.FindControl("pnlQuestion");
