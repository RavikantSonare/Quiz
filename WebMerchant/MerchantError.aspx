<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerchantError.aspx.cs" Inherits="WebMerchant.MerchantError" %>
                ...
                <div class="col-md-12">
                    <div class="error-template">
                        ...
                        <div class="error-details">
                            Sorry, server not responding please try again!
               
                        </div>
                        <div class="error-actions text-center">
                            <asp:Button ID="btnbacktohome" runat="server" Text="Back To Home" CssClass="btn btn-success" OnClick="btnbacktohome_Click" />
                        </div>
